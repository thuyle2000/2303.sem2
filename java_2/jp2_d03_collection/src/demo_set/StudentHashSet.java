/*
CT Quan Ly danh sach sinh vien trong cau truc HashSet. bao gom cac chuc nang
    - them
...
public class StudentHashSet {
    ...
    public static void main(String[] args) {
        new StudentHashSet().menu();
    }

    Set<Student> ds = new HashSet<>();
    ...
    private void create() {
        ...
        if (ds.add(sv)) {           // luu bien sv vo HashSet [ds] 
